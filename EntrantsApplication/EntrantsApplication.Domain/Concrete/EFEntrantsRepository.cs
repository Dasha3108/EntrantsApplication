...
namespace EntrantsApplication.Domain.Concrete
{
    public class EFEntrantsRepository: IEntrantsRepository
    {
        ...
        public IEnumerable<Entrant> getEntrantsFromDatabaseBySpeciality(string specialityName)
        {
            return _entrantsContext.Entrants.Where(entrant => entrant.Speciality == specialityName).ToList();
        }
